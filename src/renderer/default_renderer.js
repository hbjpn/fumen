...
export class DefaultRenderer extends Renderer
{
	 ...
	 */
	draw_boundary(side, e0, e1, hasNewLine, paper, x, y_body_base, param, draw)
	{
	...
	render_chord_as_string(chord, transpose, half_type, paper, x, y_body_base,
			param, draw)
	{
		var row_height = param.row_height;
	...
	render_empty_rythm_slash(paper, x_body_base, rs_y_base, _5lines_intv, body_width, numslash, body_scaling)
	{
		var group = paper.set();
	...
	render_simile_mark(draw, paper, group, x, y_body_base, row_height, numslash, put_boundary, align)
	{
		var h = 4;
		var H = 12;
		var i = 4;
	...
	draw_notes(x, paper, group, balken, rs_y_base, _5lines_intv,
	...
	render_rs_area(x, elems, paper, rs_y_base, _5lines_intv, meas_start_x, meas_end_x,
	...
	render_rest(e, paper, draw, x, y_body_or_rs_base, C7_width, _5lines_intv, param)
	{
	...
	render_measure_row(x, paper, macros,
	...
	render_impl(canvas, track, just_to_estimate_size, param, async_mode, progress_cb, context)
	{
